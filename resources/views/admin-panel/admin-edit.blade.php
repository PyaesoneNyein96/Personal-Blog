                ...
                <div class="card">
                    ...
                    <div class="card-body mx-2">
                        ...
                        <div class="profile ">
                            ...
                            <img src="{{asset("storage/profile-img/$adminuser->image")}}" class="w-25 img-fluid mb-2" alt="OldProfile">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control w-50" name="name" value="{{ $adminuser->name }}" required>
                        </div>

                        <div class="mb-2">
                            <label for="email" class="form-label mt-2">Email</label>
                            <input type="text" class="form-control w-50" name="email" value="{{ $adminuser->email }}" required>
                        </div>
